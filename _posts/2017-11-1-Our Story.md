...
![_config.yml]({{ site.baseurl }}/images/tractor.png)
![_config.yml]({{ site.baseurl }}/images/white-leg-tables.png)
![_config.yml]({{ site.baseurl }}/images/black-v-table.png)
![_config.yml]({{ site.baseurl }}/images/iron-leg-table.png)
![_config.yml]({{ site.baseurl }}/images/table-kitchen.png)
![_config.yml]({{ site.baseurl }}/images/white-leg-island.png)
![_config.yml]({{ site.baseurl }}/images/unfinished-stool.png)
